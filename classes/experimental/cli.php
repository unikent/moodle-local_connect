...
// First, deletes.
$deletes = \local_connect\experimental\sync::get_deleted_enrolments();
$count = count($deletes);
...
// Then, odd changes.
$changes = \local_connect\experimental\sync::get_changed_enrolments();
$count = count($changes);
...
// Then, creates.
$creates = \local_connect\experimental\sync::get_new_enrolments();
$count = count($creates);
