...
/**
 * Connect course handbook container.
 */
class course_handbook extends data
{
    /**
     * The name of our connect table.
     */
    protected static function get_table() {
        return "connect_course_handbook";
    }
    ...
    protected final static function valid_fields() {
        return array('id', 'module_code', 'synopsis', 'publicationssynopsis', 'contacthours',
