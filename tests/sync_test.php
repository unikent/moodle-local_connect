...
class kent_sync_tests extends \local_connect\tests\connect_testcase
{
    ...
    public function test_group_creates() {
        ...
        $this->assertEquals(array(), \local_connect\util\experimental\sync::get_new_groups());
        ...
        $this->assertEquals(20, count(\local_connect\util\experimental\sync::get_new_groups()));
    ...
    public function test_group_enrolment_creates() {
        ...
        $this->assertEquals(array(), \local_connect\util\experimental\sync::get_new_group_enrolments());
        ...
        $this->assertEquals(32, count(\local_connect\util\experimental\sync::get_new_group_enrolments()));
        ...
        $this->assertEquals(array($teacher), \local_connect\util\experimental\sync::get_new_group_enrolments());
    ...
    public function test_group_enrolment_deletes() {
        ...
        $this->assertEquals(array(), \local_connect\util\experimental\sync::get_new_group_enrolments());
        $this->assertEquals(array(), \local_connect\util\experimental\sync::get_deleted_group_enrolments());
        ...
        $this->assertEquals(31, count(\local_connect\util\experimental\sync::get_new_group_enrolments()));
        ...
        $this->assertEquals(array(), \local_connect\util\experimental\sync::get_new_group_enrolments());
        $this->assertEquals(array($teacher), \local_connect\util\experimental\sync::get_deleted_group_enrolments());
